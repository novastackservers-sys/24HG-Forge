...
RUN rpm-ostree install \
    ...
    && cp /tmp/forge-build/desktop/forge-tour.desktop /etc/skel/.config/autostart/ \
    \
    ...
    && cp /tmp/forge-build/desktop/forge-discord-rpc.desktop /etc/skel/.config/autostart/ \
    \
    ...
    && ln -sf ../forge-notify.service /etc/skel/.config/systemd/user/default.target.wants/forge-notify.service \
    ...
    && ln -sf ../forge-digest.timer /etc/skel/.config/systemd/user/timers.target.wants/forge-digest.timer \
    && cp /tmp/forge-build/systemd-user/forge-crash-report.service /etc/skel/.config/systemd/user/ \
    && ln -sf ../forge-crash-report.service /etc/skel/.config/systemd/user/default.target.wants/forge-crash-report.service \
    ...
    && ln -sf ../forge-deals.timer /etc/skel/.config/systemd/user/timers.target.wants/forge-deals.timer \
    ...
    && ln -sf ../forge-challenges.timer /etc/skel/.config/systemd/user/timers.target.wants/forge-challenges.timer \
    \
    # ── Wave 19 systemd services ── \
    ...
    \
    # ── Enable Wave 19 + 20 user services on login ── \
    && mkdir -p /etc/skel/.config/systemd/user/default.target.wants \
    && mkdir -p /etc/skel/.config/systemd/user/timers.target.wants \
    && ln -sf ../forge-game-ready.service /etc/skel/.config/systemd/user/default.target.wants/forge-game-ready.service \
    && ln -sf ../forge-smart-updates.service /etc/skel/.config/systemd/user/default.target.wants/forge-smart-updates.service \
    && ln -sf ../forge-hw-scout.service /etc/skel/.config/systemd/user/default.target.wants/forge-hw-scout.service \
    && ln -sf ../forge-perf-profiles.service /etc/skel/.config/systemd/user/default.target.wants/forge-perf-profiles.service \
    && ln -sf ../forge-power-plan.service /etc/skel/.config/systemd/user/default.target.wants/forge-power-plan.service \
    && ln -sf ../forge-tray-dashboard.service /etc/skel/.config/systemd/user/default.target.wants/forge-tray-dashboard.service \
    && ln -sf ../forge-quick-resume.service /etc/skel/.config/systemd/user/default.target.wants/forge-quick-resume.service \
    && ln -sf ../forge-peripherals.service /etc/skel/.config/systemd/user/default.target.wants/forge-peripherals.service \
