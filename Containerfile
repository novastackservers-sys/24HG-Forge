...
RUN rpm-ostree install \
    ...
    \
    # ── Cloud Gaming ── \
    && install -m 755 /tmp/forge-build/bin/forge-cloud-gaming /usr/bin/forge-cloud-gaming \
    && cp /tmp/forge-build/desktop/forge-cloud-gaming.desktop /usr/share/applications/ \
    \
    # ── Lib scripts ── \
